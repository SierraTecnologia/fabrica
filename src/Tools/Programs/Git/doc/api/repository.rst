...
.. code-block:: php
    ...
    $repository = new Fabrica\Tools\Programs\Git\Repository('/tmp/foo', array('command' => '/home/alice/bin/git'));
...
.. code-block:: php
    ...
    $repository = new Fabrica\Tools\Programs\Git\Repository('/tmp/foo', array('environment_variables' => array('GIT_')))
