...
class ProfileController extends Controller
{
    ...
    public function deleteSshKeyAction(Request $request, $id)
    {
        ...
        $userSshKey = $this->getRepository('FabricaCoreBundle:UserSshKey')->find($id);
    ...
    public function createSshKeyAction(Request $request)
    {
        ...
        if ('POST' === $request->getMethod() && $form->bind($request)->isValid()) {
            ...
            $this->setFlash('success', $message);
            $this->get('fabrica.job_manager')->delegate(new UpdateSshKeysJob());
    ...
    {
        $user = $this->getUser();
        $repo = $this->getRepository('FabricaCoreBundle:Email');
