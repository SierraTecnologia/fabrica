...
namespace Fabrica\Bundle\DistributionBundle\Controller;
...
use Fabrica\Bundle\DistributionBundle\Installation\StepList;
...
class ConfigurationController extends Controller
{
    ...
    public function saveStepAction(Request $request, $slug)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('fabricadistribution_configuration_step', array('slug' => $step->getSlug())));
        }
    ...
    {
        return $this->get('fabrica_distribution.steps');
    }
