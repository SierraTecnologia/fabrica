...
/**
 * Test client for Fabrica application.
 *
...
class Client extends BaseClient
{
    ...
    public function startIsolation()
    {
        ...
        if (null !== $this->repositoryPool) {
            $this->getContainer()->set('fabrica_core.git.repository_pool', $this->repositoryPool);
        }

        if (null !== $this->hookInjector) {
            $this->getContainer()->set('fabrica_core.git.hook_injector', $this->hookInjector);
        }

        if (null !== $this->shellHandler) {
            $this->getContainer()->set('fabrica_core.git.shell_handler', $this->shellHandler);
        }
