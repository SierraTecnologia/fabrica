...
abstract class AbstractCommand extends ContainerAwareCommand
{
    public function getProject($projectSlug)
    {
        ...
        $project  = $doctrine->getRepository('FabricaCoreBundle:Project')->findOneBySlug($projectSlug);
    ...
    {
        $doctrine = $this->getContainer()->get('doctrine');
        $user     = $doctrine->getRepository('FabricaCoreBundle:User')->findOneByUsername($username);
    ...
    {
        $doctrine = $this->getContainer()->get('doctrine');
        $role     = $doctrine->getRepository('FabricaCoreBundle:Role')->findOneBySlug($slug);
